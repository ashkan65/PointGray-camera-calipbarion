...
public:
    ...
    void validate()
    {
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    std::cout<<readStringList(input, imageList);
                    inputType = IMAGE_LIST;
                    // std::cout<<"this:"<<inputType<<"\n";
    ...
    Mat nextImage()
    {
        ...
        if( inputCapture.isOpened() )
        {
            ...
            // std::cout<<"reading image\n"<<imageList[atImageList++]<<"-------\n";
            result = imread(imageList[atImageList++], IMREAD_COLOR);
            // result = imread("../CalibImage/1.png", IMREAD_COLOR);
